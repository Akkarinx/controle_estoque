    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/uniruy.png" alt="" width="150px" height="100px"></a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
             ...
             <span class="glyphicon glyphicon-list-alt"></span> Gestão Produtos<span class="caret"></span></a>
          ...
          <li class="dropdown" >
            ...
            <ul class="dropdown-menu">
              <li> <a style="color: red" href="../procedimentos/logoff.php"><span class="glyphicon glyphicon-off"></span> Sair</a></li>
